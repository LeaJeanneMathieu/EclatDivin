  ...
  return (
    <header style={{ background: '#F6EBD7' }}>
      <div className="container" style={{ maxWidth: 1400, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 24px' }}>
        <span style={{ fontFamily: 'Playfair Display, serif', fontSize: 32, letterSpacing: 3, color: '#2b2b2b' }}>ECLAT DIVIN</span>
        <nav style={{ display: 'flex', gap: 32, alignItems: 'center', fontSize: 20, letterSpacing: 1 }}>
